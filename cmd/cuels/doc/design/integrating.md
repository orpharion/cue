...
[`cuelang.org/go/pkg/golang_x_tools_internal/span`] has the code to do this in go.
...
[InitializeResult]: https://pkg.go.dev/cuelang.org/go/pkg/lsp/protocol#InitializeResult
[ServerCapabilities]: https://pkg.go.dev/cuelang.org/go/pkg/lsp/protocol#ServerCapabilities
[`cuelang.org/go/pkg/golang_x_tools_internal/span`]: https://pkg.go.dev/cuelang.org/go/pkg/golang_x_tools_internal/span#NewPoint
