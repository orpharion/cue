...
import _ "cuelang.org/go/pkg/lsp/assign/internal/secret" //@diag("\"cuelang.org/go/pkg/lsp/assign/internal/secret\"", "compiler", "could not import cuelang.org/go/pkg/lsp/assign/internal/secret (invalid use of internal package cuelang.org/go/pkg/lsp/assign/internal/secret)", "error")
