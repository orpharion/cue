...
import (
	...
	"cuelang.org/go/pkg/golang_x_tools_internal/analysisinternal"
...
func typesCodeHref(snapshot *snapshot, code typesinternal.ErrorCode) string {
	...
	return fmt.Sprintf("https://%s/cuelang.org/go/pkg/golang_x_tools_internal/typesinternal#%s", target, code.String())
}
