...
import (
	...
	"cuelang.org/go/pkg/golang_x_tools_internal/lsp/cmd"
	"cuelang.org/go/pkg/golang_x_tools_internal/lsp/debug"
	"cuelang.org/go/pkg/golang_x_tools_internal/lsp/lsprpc"
