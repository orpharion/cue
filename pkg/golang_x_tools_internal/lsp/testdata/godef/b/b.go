...
import (
	myFoo "cuelang.org/go/pkg/golang_x_tools_internal/lsp/foo" //@mark(myFoo, "myFoo"),godef("myFoo", myFoo)
	"cuelang.org/go/pkg/golang_x_tools_internal/lsp/godef/a"   //@mark(AImport, re"\".*\"")
)
