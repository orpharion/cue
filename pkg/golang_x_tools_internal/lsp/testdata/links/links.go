...
import (
	...
	"cuelang.org/go/pkg/golang_x_tools_internal/lsp/foo" //@link(`cuelang.org/go/pkg/golang_x_tools_internal/lsp/foo`,`https://pkg.go.dev/cuelang.org/go/pkg/golang_x_tools_internal/lsp/foo?utm_source=gopls`)
