...
import (
	...
	"cuelang.org/go/pkg/golang_x_tools_internal/lsp/command/commandmeta"
)
...
func Generate() ([]byte, error) {
	...
	d := data{
		...
		Imports: map[string]bool{
			"context": true,
			"fmt":     true,
			"cuelang.org/go/pkg/golang_x_tools_internal/lsp/protocol": true,
		},
	}
	const thispkg = "cuelang.org/go/pkg/golang_x_tools_internal/lsp/command"
